...
import { Wifi, WifiOff, Smartphone, Power } from 'lucide-react'
...
export default function ConexoesPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="font-display font-bold text-[22px] tracking-tight text-t1">Conexões</h1>
        <p className="text-sm text-t2 mt-0.5">Gerencie as conexões e o status da assistente</p>
      </div>
      ...
      <Card>
        <div className="px-6 py-4" style={{ borderBottom: '1px solid var(--border)' }}>
          <p className="text-sm font-semibold text-t1">WhatsApp</p>
          <p className="text-xs text-t3 mt-0.5">Conecte o número de WhatsApp do seu consultório à assistente</p>
        </div>
