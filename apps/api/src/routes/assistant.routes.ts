    ...
    if (existing) {
      ;[assistant] = await query(
        `UPDATE assistants SET
           name = COALESCE($2, name), tone = COALESCE($3, tone),
           greeting_message = COALESCE($4, greeting_message),
           consultation_price = COALESCE($5, consultation_price),
           consultation_modalities = COALESCE($6, consultation_modalities),
           specialties = COALESCE($7, specialties),
           vacation_mode = COALESCE($8, vacation_mode),
           vacation_message = COALESCE($9, vacation_message),
           followup_enabled = COALESCE($10, followup_enabled),
           followup_delay_hours = COALESCE($11, followup_delay_hours),
           service_plans = COALESCE($12, service_plans),
           nutri_display_name = COALESCE($13, nutri_display_name),
           emoji_level = $14,
           func_prospeccao = $15, func_triagem = $16, func_agendamento = $17,
           followup_message_1 = COALESCE($18, followup_message_1),
           followup_message_2 = COALESCE($19, followup_message_2),
           services_message = COALESCE($20, services_message),
           services_message_enabled = COALESCE($21, services_message_enabled),
           services_message_online = COALESCE($22, services_message_online),
           services_message_online_enabled = COALESCE($23, services_message_online_enabled),
           services_message_presencial = COALESCE($24, services_message_presencial),
